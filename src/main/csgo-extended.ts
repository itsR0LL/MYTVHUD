...
declare const mapSteamIDToPlayer: (
  players: PlayersRaw,
  teams: {
    CT: Team
    T: Team
...
declare const didTeamWinThatRound: (
  team: Team,
  round: number,
  wonBy: Side,
  currentRound: number,
...
export {
  ...
  CSGOGSI,
  type CSGORaw,
  type DecoySmokeGrenade,
  type DecoySmokeGrenadeRaw,
  type Events,
  type FragOrFireBombOrFlashbandGrenade,
  type FragOrFireBombOrFlashbandGrenadeRaw,
  type Grenade,
  type GrenadeBase,
  type GrenadeBaseRaw,
  type GrenadeRaw,
